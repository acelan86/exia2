...
define([
    ...
    "hbs!../Page/templates/page",

    "css!./styles/frame.css"
], function (_, $, Backbone, boundsUtils, pageTemplate) {
    "use strict";
    ...
    Frame.prototype.load = function (body) {
        body = body || '';

        var me = this,
            frameHTML = pageTemplate({
                body : body + '<script' + '>parent.FrameDocument = document; parent.FrameWindow = window;</' + 'script>'
            });
